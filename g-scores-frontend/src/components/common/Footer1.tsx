...
export default function Footer1({
  ...
  function LeftSection() {
    return (
      <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
        ...
        <p className="text-white/70 mb-4 text-sm sm:text-base max-w-md">
          {websiteDescription}
        </p>
  ...
  function RightSection() {
    return (
      <div className="w-full lg:w-1/2 ">
        <div className="flex flex-wrap justify-end gap-8 sm:gap-12 lg:gap-16 xl:gap-20">
  ...
  return (
    <footer
      id={sectionId}
      className={`w-screen py-6 sm:py-8 lg:py-12 flex flex-col gap-4 text-sm
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-4 text-xs sm:text-sm">
        <div className="text-center sm:text-left">
          ...
          <span className="ml-1 text-white/70">&copy; All rights reserved.</span>
        </div>
